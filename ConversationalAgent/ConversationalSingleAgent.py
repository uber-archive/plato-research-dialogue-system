...
from UserSimulator.ReactiveAssistantSimulator.ReactiveAssistantUserSimulator \
    import ReactiveAssistantUserSimulator
...
from UserSimulator.uEatsUserSimulator.uEatsUS import uEatsUS
...
from NLU.uEatsNLU import uEatsNLU
from NLU.ReactiveAssistantNLU import ReactiveAssistantNLU
from NLU.CamRestNLU import CamRestNLU
from NLG.DummyNLG import DummyNLG
from NLG.uEatsNLG import uEatsNLG
        ...
        if self.configuration:
            ...
            if 'USER_SIMULATOR' in self.configuration['AGENT_0']:
                ...
                if a0_sim_config and a0_sim_config['simulator']:
                    ...
                    if a0_sim_config['simulator'] == 'agenda':
                    ...
                    elif a0_sim_config['simulator'] == 'RA':
                        if 'nlg' in a0_sim_config:
                            self.USER_SIMULATOR_NLG = True
                            self.user_simulator_args['nlg'] = \
                                a0_sim_config['nlg']

                        self.user_simulator = ReactiveAssistantUserSimulator(
                            self.user_simulator_args
                        )

                    elif a0_sim_config['simulator'] == 'uEats':
                        if 'patience' in a0_sim_config:
                        ...
                        self.user_simulator = uEatsUS(self.user_simulator_args)
            ...
            if 'NLU' in self.configuration['AGENT_0'] and \
                ...
                elif self.configuration['AGENT_0']['NLU']['nlu'] == 'uEats':
                    self.nlu = uEatsNLU(nlu_args)
            ...
            if 'NLG' in self.configuration['AGENT_0'] and \
                ...
                elif self.configuration['AGENT_0']['NLG']['nlg'] == 'uEats':
                    self.nlg = uEatsNLG({})

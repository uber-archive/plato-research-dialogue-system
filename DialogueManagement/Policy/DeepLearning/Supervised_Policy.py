...
class Supervised_Policy(Policy.Policy):
    ...
    def load(self, path=None):
        ...
        if os.path.isfile(pol_path + '.meta'):
            ...
            print('WARNING! Supervised Policy cannot load policy model from {0}!'.format(pol_path))

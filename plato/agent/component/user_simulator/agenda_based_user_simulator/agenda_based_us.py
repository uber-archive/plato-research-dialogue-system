...
from plato.agent.component.user_simulator.agenda_based_user_simulator import \
    error_model, agenda
from plato.agent.component.user_simulator import goal, \
    user_simulator

# TODO: Remove these dependencies on applications
from applications.cambridge_restaurants.camrest_nlg import CamRestNLG
from applications.cambridge_restaurants.camrest_nlu import CamRestNLU

"""
AgendaBasedUS is Plato's implementation of the Agenda-Based Simulated User, as 
described in: 
...
class AgendaBasedUS(user_simulator.UserSimulator):
    """
    ...
    def __init__(self, args):
        ...
        self.error_model = error_model.ErrorModel(self.ontology,
                                                  self.database,
    ...
    def receive_input(self, inpt, in_goal=None):
        """
        ...
        :param in_goal: the simulated user's goal
        :return: Nothing
        """
    ...
    def load(self, path):
        """
        Load an Agenda-Based Simulated usr dialogue_policy

        :param path: path to the dialogue_policy file
        :return: nothing
        """
        ...
        if isinstance(path, str):
            if os.path.isfile(path):
                with open(path, 'rb') as file:
                    ...
                    print('ABUS dialogue_policy loaded.')
